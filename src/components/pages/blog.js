...
class Blog extends Component {
  ...
  handleDeleteClick(blog) {
    console.log('%c Deleting blog item...', 'color: red;', blog)
    axios
    ...
    .catch(error => {
      console.log('%c delete blog error', 'color: red', error)
    });
  }
  ...
  getBlogItems() {
    ...
    axios.get(
      `https://brianmote.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, { 
        withCredentials: true 
      })
    .then(response => {
