...
export default class PortfolioForm extends Component {
  constructor(props) {
      ...
      this.state = {
          ...
          logo: "",
          editMode: false,
          apiUrl: "https://brianmote.devcamp.space/portfolio/portfolio_items",
          apiAction: 'post'
      };
  ...
  componentDidUpdate() {
    if (Object.keys(this.props.portfolioToEdit).length > 0) {
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://brianmote.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
    ...
    axios({
      ...
      .then(response => {
        if (this.state.editMode) {
          this.props.handleEditFormSubmit(response.data.portfolio_item);
        } else {
