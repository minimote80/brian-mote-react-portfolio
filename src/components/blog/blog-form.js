...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://brianmote.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        }
    ...
    axios
      .delete(
          `https://api.devcamp.space/portfolio/delete-portfolio-blog-image/${
             this.props.blogToEdit.id}?image_type${imageType}}`,
    ...
    componentWillMount() {
        ...
        const { 
          ...
          this.setState({
            ...
            content: content,
            apiUrl: `https://brianmote.devcamp.space/portfolio/portfolio_blogs/${id}`,
            apiAction: "patch"
          });
        }
      }
